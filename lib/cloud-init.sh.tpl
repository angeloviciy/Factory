...
# Push any unpushed commits and create PR
PR_NUMBER=""
...
if [ "$COMMITS_AHEAD" != "0" ]; then
    echo "[factory] Pushing $COMMITS_AHEAD unpushed commits..."
    git push -u origin "$BRANCH"
fi

# Always try to find or create a PR for this branch
...
Review the changes carefully before merging."
    ...
    if [ -n "$PR_URL" ]; then
        ...
        echo "[factory] Could not create PR"
    fi
else
